...
import { PaycrestService } from '../../../../src/modules/paycrest/paycrest.service';
import { ConfigService } from '@nestjs/config';
import { HttpModule } from '@nestjs/axios';
import { HttpErrorException } from '../../../../src/common/exceptions/http-error.exception';
import { API_PATHS } from '../../../../src/modules/paycrest/constants';
...
describe('PaycrestService', () => {
  ...
  describe('getSupportedInstitutions', () => {
    it('should return supported institutions successfully', async () => {
      ...
      // Then
      expect(result).toEqual(mockResponse.data);
      expect((service as any).httpClient.get).toHaveBeenCalledWith(
        API_PATHS.INSTITUTIONS,
        expect.objectContaining({
          baseURL: 'https://api.paycrest.io',
          headers: expect.any(Object)
        })
