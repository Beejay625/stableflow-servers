...
// import { PaycrestApiService } from '../../modules/offramp/paycrest-api.service'; - Removed as offramp module is no longer used
import axios from 'axios';
import { handleAxiosError, retryWithBackoff } from '../utils/http.util';
import { HttpStatus } from '@nestjs/common';
import { HttpErrorException } from '../exceptions';
import { BlockradarApiService } from '../../modules/wallet/blockradar-api.service';
...
describe('External API Services', () => {
  // let paycrestService: PaycrestApiService; - Removed as offramp module is no longer used
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        // }, - Removed as offramp module is no longer used
        {
    ...
    // paycrestService = module.get<PaycrestApiService>(PaycrestApiService); - Removed as offramp module is no longer used
    blockradarService = module.get<BlockradarApiService>(BlockradarApiService);
  });

  it('should create both services', () => {
    // expect(paycrestService).toBeDefined(); - Removed as offramp module is no longer used
  ...
  describe('Error handling', () => {
    it('should use retry mechanism for API calls', async () => {
      ...
      // (paycrestService as any).axios = mockAxiosInstance; - Removed as offramp module is no longer used
      (blockradarService as any).axios = mockAxiosInstance;
      
      // Call a method that uses retryWithBackoff
      // await (paycrestService as any).get('/test'); - Removed as offramp module is no longer used
