...
async function checkBusinessWallet(businessId: string) {
  ...
  try {
    ...
    console.log(
      `Wallet Address: ${business.walletDetails?.address || "Not set"}`,
    );
    console.log(
      `Address ID: ${business.walletDetails?.addressId || "Not set"}`,
    );
    ...
    if (business.bankDetails) {
      ...
      console.log(
        `Account number: ${business.bankDetails.accountNumber || "Not set"}`,
      );
      console.log(
        `Account name: ${business.bankDetails.accountName || "Not set"}`,
      );
      console.log(
        `Account type: ${business.bankDetails.accountType || "Not set"}`,
      );
    } else {
