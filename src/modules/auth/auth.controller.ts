...
import { BusinessAuthResponseDto } from './dto/business-auth-response.dto';
...
export class AuthController {
  ...
  async verifyOtp(
    ...
    return this.authService.verifyOtpWithBusinessId(validateOtpDto.email, validateOtpDto.otp);
  }
}
