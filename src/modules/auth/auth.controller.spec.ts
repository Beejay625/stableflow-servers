...
describe('AuthController', () => {
  ...
  describe('verifyOtp', () => {
    it('should call authService.verifyOtpWithBusinessId with email and OTP', async () => {
      ...
      expect(result).toEqual(expectedResult);
      expect(mockAuthService.verifyOtpWithBusinessId).toHaveBeenCalledWith(dto.email, dto.otp);
    });
    ...
    it('should handle unauthorized exceptions', async () => {
      ...
      mockAuthService.verifyOtpWithBusinessId.mockRejectedValue(new UnauthorizedException('Invalid OTP.'));
